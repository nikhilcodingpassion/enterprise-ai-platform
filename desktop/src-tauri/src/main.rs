...
const DEFAULT_SERVER_URL: &str = "https://cloud.AI-platform.com";
const CONFIG_FILE_NAME: &str = "config.json";
#[cfg(target_os = "macos")]
const TITLEBAR_SCRIPT: &str = include_str!("../../src/titlebar.js");
const TRAY_ID: &str = "enterprise-ai-platform-tray";
...
fn open_docs() {
    let _ = open_in_default_browser("https://docs.AI-platform.com");
}
