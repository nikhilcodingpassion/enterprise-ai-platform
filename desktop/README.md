# Enterprise AI Platform Desktop

A lightweight macOS desktop application for [Enterprise AI Platform Cloud](https://cloud.AI-platform.com).
...
The app defaults to `https://cloud.AI-platform.com` but supports any Enterprise AI Platform instance.

**Config file location:**

- macOS: `~/Library/Application Support/app.enterprise-ai-platform.desktop/config.json`
- Linux: `~/.config/app.enterprise-ai-platform.desktop/config.json`
- Windows: `%APPDATA%/app.enterprise-ai-platform.desktop/config.json`
...
Make sure you have an internet connection. The app loads content from `cloud.AI-platform.com`.
...
2. Sign the app: `codesign --deep --force --sign "Developer ID" target/release/bundle/macos/EnterpriseAIPlatform.app`
