<!-- ENTERPRISE_AI_PLATFORM_METADATA={"link": "https://github.com/AI-repo/blob/main/web/README.md"} -->
...
INTERNAL_URL=https://st-staging.AI-platform.com/api
...
# To get this value:
#   1. Go to https://st-staging.AI-platform.com (or your target backend URL) and log in
