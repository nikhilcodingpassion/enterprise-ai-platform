# Enterprise AI Platform Chat Widget
...
```html
<!-- Load the widget -->
<script type="module" src="https://cdn.AI-platform.com/widget/1.0/dist/enterprise-ai-platform-widget.js"></script>

<!-- Configure and display -->
<enterprise-ai-platform-chat-widget
  backend-url="https://cloud.your-platform.com/api"
...
```html
<enterprise-ai-platform-chat-widget backend-url="https://cloud.AI-platform.com/api" api-key="your_api_key">
</enterprise-ai-platform-chat-widget>
```
...
```html
<enterprise-ai-platform-chat-widget
  backend-url="https://cloud.AI-platform.com/api"
  api-key="on_abc123"
  agent-id="42"
