# Enterprise AI Platform Developer Script

[![Deploy Status](https://github.com/AI-repo/enterprise-ai-platform/actions/workflows/release-devtools.yml/badge.svg)](https://github.com/AI-repo/enterprise-ai-platform/actions/workflows/release-devtools.yml)
[![PyPI](https://img.shields.io/pypi/v/enterprise-ai-platform-devtools.svg)](https://pypi.org/project/enterprise-ai-platform-devtools/)

`ods` is [your-platform.com](https://github.com/AI-repo/enterprise-ai-platform)'s devtools utility script.
It is packaged as a python [wheel](https://packaging.python.org/en/latest/discussions/package-formats/) and available from [PyPI](https://pypi.org/project/enterprise-ai-platform-devtools/).
